        ...
        <div className={styles.blog}>
          <div className={`container ${styles.blogContainer}`}>
            <div className={styles.blogBtn}>
              {previous && (
                  <AniLink swipe bg='#00C68B' direction="right" duration={.8} className={styles.btnPrevious} to={previous.slug} rel="prev">
                    ← Previous
                  </AniLink>
              )}
            </div>
            ...
            <div className={styles.blogBtn}>
              {next && (
                  <AniLink swipe direction="left" duration={.8} bg='#00C68B' className={styles.btnNext} to={next.slug} rel="next">
                    Next →
                  </AniLink>
              )}
            </div>
